...
tfrecords_file_name = "cancer_train.csv.tfrecords"
#tfrecords_file_name = "cancer_test.csv.tfrecords"
input_file = os.path.join(current_path, tfrecords_file_name)
#input_file = "./add_one/train.csv.tfrecords"
input_file = "./multiple_two/train.csv.tfrecords"
...
for serialized_example in tf.python_io.tf_record_iterator(input_file):
  ...
  print("Number: {}, label: {}, features: {}".format(print_number, label.pop(),
                                                     features.pop()))
